...
package com.cloud_ml_app_thesis.utils;
...
public class DataInitializer implements CommandLineRunner {
    ...
    private void recreateAdmins() {
        List<AppUser> admins = List.of(
                new AppUser(null, "nikolas", "Spirou", "nikolas@gmail.com", adminPassword, 27, "Senior SWE", "Greece", UserRole.ADMIN, UserStatus.ACTIVE, null, null),
                new AppUser(null, "Nikos", "Rizogiannis", "rizo@gmail.com", adminPassword, 27, "Senior SWE", "Greece", UserRole.ADMIN, UserStatus.ACTIVE, null, null),
                new AppUser(null, "john", "kennedy", "john@gmail.com", userPassword, 27, "Senior SWE", "Greece", UserRole.USER, UserStatus.ACTIVE, null, null)
        );
